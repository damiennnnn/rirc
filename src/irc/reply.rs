pub enum Replies
{
    ...
    // WHOIS/WHOWAS
    RplWhoisHelper = 310,
    // <nick> :looks very helpful                                                       DALNET
    RplWhoIsUser = 311,
    ...
    // Channel Lists
    RplInviteList = 346,
    // <channel> <invite> <nick> <time>                                                 IRCNET
    RplEndOfInviteList = 357,
    // <channel> :End of Channel Invite List                                            IRCNET
    RplExceptList = 348,
    // <channel> <exception> <nick> <time>                                              IRCNET
    RplEndOfExceptList = 349,
    // <channel> :End of Channel Exception List                                         IRCNET
    RplBanList = 367,
    ...
    // GLINE
    RplGLineList = 280,
    // <address> <timestamp> <reason>                                                   UNDERNET
    RplEndOfGLineList = 281,                  // :End of G-line List                                                              UNDERNET

    // Silence
    RplSilenceList = 271,
    // <nick> <mask>                                                                    UNDERNET/DALNET
    ...
    ErrNoColors = 408,
    // <nickname> #<channel> :You cannot use colors on this channel. Not sent: <text>   DALNET
    ErrNoOrigin = 409,
    // :No origin specified
    ErrNoRecipient = 411,
    ...
    ErrBadMask = 415,
    ErrTooMuchInfo = 416,
    // <command> :Too many lines in the output, restrict your query                     UNDERNET
    ...
    ErrNickTooFast = 438,
    // <nick> :Nick change too fast. Please wait <sec> seconds.                         (most)
    ErrTargetTooFast = 439,
    // <target> :Target change too fast. Please wait <sec> seconds.                     DALNET/UNDERNET
    ...
    // <channel> :Only servers can change that mode                                     DALNET
    ...
    ErrBadChanMask = 476,
    ErrNickNotRegistered = 477,
    // <channel> :You need a registered nick to join that channel.                      DALNET
    ErrBanListFull = 478,
    ...
    ErrRestricted = 484,
    // <nick> <channel> :Cannot kill, kick or deop channel service                      UNDERNET
    ErrUniqOPrivsNeeded = 485,
    // <channel> :Cannot join channel (reason)
    ErrNoOperHost = 491,
